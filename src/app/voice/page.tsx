...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Both audio and video messages can be up to 5 minutes long \u2014 recorded in full HD (1080p). We find that the most meaningful messages are often just 1\u20132 minutes of heartfelt words.",
  },
  {
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2">
            ...
            <div className="relative flex flex-col rounded-2xl border-gold bg-white p-8 shadow-lg ring-2 ring-gold/30 transition hover:-translate-y-1 hover:shadow-xl">
              ...
              <ul className="mt-8 space-y-3">
                {[
                  "Record up to 5 minutes of video in HD",
