                  ...
                  {rec.download_url && (
                    <div className="mt-3 flex justify-end">
                      <a
                        ...
                        download
                        className="inline-flex items-center gap-2 rounded-full border border-cream-dark bg-white px-4 py-2 text-sm font-medium text-navy shadow-sm transition hover:bg-cream"
                      >
                        <svg
                        ...
                        Download {isPhoto ? "photo" : isVideo ? "video" : "audio"}
                      </a>
                    </div>
                  )}
                </div>
